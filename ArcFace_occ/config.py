...
config.val_targets = ['lfw', 'cfp_fp', 'agedb_30','lfw-masked', 'cfp_fp-masked', 'agedb_30-masked','rmfrd']
config.ce_loss = True
...
# default.lr_steps = '40000,75000,100000'
# default.lr_steps = '12000,20000,25000'
